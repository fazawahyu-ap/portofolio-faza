...
def home():
    translations = {
        "id": {
            ...
            "hero_subtitle": "Junior AI System Analyst",
            "hero_cv_button": "Download CV",
            "hero_about_button": "Tentang Saya",
            "hero_email_button": "Email",
            "about_title": "Tentang Saya",
            "about_summary": "Mahasiswa Teknik Informatika dengan minat kuat pada pengembangan produk digital dan teknologi AI. Berbekal pemahaman dari mata kuliah seperti Analisa Perancangan Perangkat Lunak dan Interaksi Manusia & Komputer, serta soft skill pemecahan masalah dan ketelitian yang terasah, saya siap berkontribusi dalam pengujian dan pengelolaan fitur AI untuk meningkatkan customer experience.",
            ...
            "achieve_1_title": "Top 8% Pemenang di #JuaraGCP Season 11 2025!",
            "achieve_1_org": "Google Cloud",
            "achieve_1_date": "Mei 2025",
            "achieve_1_desc": "Berhasil meraih peringkat dalam 1.000 peserta teratas dari total 12.000 peserta pada program #JuaraGCP Season 11 yang diselenggarakan oleh Google Cloud. Pencapaian ini diraih setelah menyelesaikan serangkaian modul pelatihan dan ujian akhir mengenai fundamental Google Cloud Platform. Prestasi ini menunjukkan kemampuan untuk mempelajari dan menguasai materi teknis baru secara cepat dalam lingkungan yang kompetitif.",
        ...
        "en": {
            ...
            "about_summary": "A Computer Engineering student with a strong interest in digital product development and AI technology. Equipped with knowledge from courses such as Software Analysis & Design and Human-Computer Interaction, along with well-developed soft skills in problem-solving and attention to detail, I am ready to contribute to the testing and management of AI features to enhance customer experience.",
            "about_name_label": "Name:",
            "about_name_value": "Faza Wahyu Adi Putra",
            "about_location_label": "Location:",
            "about_location_value": "Semarang, Indonesia",
            "about_email_label": "Email",
            "achieve_1_title": "Top 8% Winner in #JuaraGCP Season 11 2025!",
            "achieve_1_org": "Google Cloud",
            "achieve_1_date": "May 2025",
            "achieve_1_desc": "Achieved a ranking within the top 1,000 out of 12,000 participants in the #JuaraGCP Season 11 program hosted by Google Cloud. This was accomplished by completing a series of training modules and a final exam on Google Cloud Platform fundamentals. This achievement demonstrates the ability to quickly learn and master new technical material in a competitive environment.",
